...
def _param_float(params, key, scale):
  """Read an integer param and scale it to float."""
  return int(params.get(key, encoding="utf8")) * scale
...
def set_lat_tune(tune, name, max_lat_accel=2.5, FRICTION=.1):
  ...
  if name == LatTunes.ATOM:
    ...
    # 1. TORQUE
    TorqueKp = _param_float(params, "TorqueKp", 0.1)
    TorqueKf = _param_float(params, "TorqueKf", 0.1)
    TorqueKi = _param_float(params, "TorqueKi", 0.1)
    TorqueFriction = _param_float(params, "TorqueFriction", 0.001)
    TorqueUseAngle = params.get_bool('TorqueUseAngle')
    max_lat_accel = _param_float(params, "TorqueMaxLatAccel", 0.1)
    steer_ang_deadzone = _param_float(params, "TorqueAngDeadZone", 0.1)
    ...
    LqrKi = _param_float(params, "LqrKi", 0.001)
    DcGain = _param_float(params, "DcGain", 0.00001)
    ...
    # 3. INDI
    InnerLoopGain = _param_float(params, "InnerLoopGain", 0.1)
    OuterLoopGain = _param_float(params, "OuterLoopGain", 0.1)
    TimeConstant = _param_float(params, "TimeConstant", 0.1)
    ActuatorEffectiveness = _param_float(params, "ActuatorEffectiveness", 0.1)
    ...
    # 4. PID
    PidKp = _param_float(params, "PidKp", 0.01)
    PidKi = _param_float(params, "PidKi", 0.001)
    PidKd = _param_float(params, "PidKd", 0.01)
    PidKf = _param_float(params, "PidKf", 0.00001)
