...
| 커밋 | 날짜 | 설명 |
|------|------|------|
| `36de7f2` | 2026-07-19 | C2 주행 로그 온·오프 안내, 오프로드 비동기 삭제 및 활성·진단 로그 보호 |
| `5646dcf` | 2026-07-19 | C2 경량 프로세스 로그 상시 보존 및 logger 사용 시 bootlog 복원 |
| `748a066` | 2026-07-19 | C2 프로세스 재시작 최고속도 복구, loggerd lock 정리 및 회귀 테스트 |
| `1d861f9` | 2026-07-19 | C2 운전자 크루즈 최고속도 단일 소유권 및 로컬 로그 저장공간 보호 |
